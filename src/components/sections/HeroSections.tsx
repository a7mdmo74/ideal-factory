      ...
      <div className="relative mx-auto flex min-h-screen items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl rounded-4xl bg-black/50 p-8 shadow-[0_30px_90px_-40px_rgba(0,0,0,0.8)] sm:p-12 lg:p-16">
          ...
          <Button
            asChild
            size="lg"
            className="mt-10 inline-flex items-center gap-2 rounded-[10px] bg-white px-8 py-3.5 font-bold text-lg text-[#231F20] shadow-2xl transition hover:bg-primary hover:text-white"
          >
            <Link href="/contact">
              {t('ctaPrimary')}
